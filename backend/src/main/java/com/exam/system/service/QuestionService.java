...
public class QuestionService {
    ...
    public List<QuestionDTO> getQuestions(Long gradeId, Long subjectId, String knowledgePoint) {
    ...
    public IPage<QuestionDTO> getQuestionsPaginated(int page, int size, Long gradeId, Long subjectId, String knowledgePoint) {
