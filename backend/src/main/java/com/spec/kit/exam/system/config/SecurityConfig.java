    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.cors(cors -> cors.configurationSource(corsConfigurationSource()))
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(org.springframework.http.HttpMethod.POST, "/api/classes", "/api/classes/**").hasAnyRole("ADMIN", "PRINCIPAL", "SUPER_ADMIN")
                .requestMatchers(org.springframework.http.HttpMethod.PUT, "/api/classes/**").hasAnyRole("ADMIN", "PRINCIPAL", "SUPER_ADMIN")
                .requestMatchers(org.springframework.http.HttpMethod.DELETE, "/api/classes/**").hasAnyRole("ADMIN", "PRINCIPAL", "SUPER_ADMIN")
                .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/classes", "/api/classes/**").hasAnyRole("ADMIN", "PRINCIPAL", "SUPER_ADMIN", "TEACHER", "STUDENT", "USER")
                .requestMatchers(org.springframework.http.HttpMethod.POST, "/api/subjects", "/api/subjects/**").hasAnyRole("ADMIN", "PRINCIPAL", "SUPER_ADMIN")
